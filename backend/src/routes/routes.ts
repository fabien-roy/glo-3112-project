...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/users',
            function (request: any, response: any, next: any) {
            const args = {
                    userCreationRequest: {"in":"body","name":"userCreationRequest","required":true,"ref":"UserCreationRequest"},
            };
        ...
        app.post('/users/:username/posts',
            ...
            const args = {
                    username: {"in":"path","name":"username","required":true,"dataType":"string"},
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"PostCreationRequest"},
            };
